...
<%
    ...
    out.println("<div class=\"container\">");
        ...
        out.println("<div class=\"row\">");
            ...
            out.println("</div>");
            out.println("<div class=\"col\">");
                out.println("<div class=\"card panel-shadow panel panel-info\" style=\"width: 550px;\">\n" +
                ...
                out.println("<tr><td colspan=\"5\"  style=\"width: 550px;\" style=\"height: 20px;\"></td></tr>");
                for(int i=0; null!=book && i < book.size(); i++) {
                    out.println("<tr><td colspan=\"5\" width =\"550\"><img src = \"./images/" + book.get(i).getImage() + "\" height=\"100\" width=\"100\"/></td></tr>");
