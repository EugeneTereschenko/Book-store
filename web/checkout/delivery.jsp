...
<div class="alert alert-primary" role="alert">
    <table><tr><td>Step1</td><td><button type="button" class="btn btn-primary btn-sm" id="id_button_step2">Step2</button></td><td>Step3</td><td><%= session.getAttribute("username") %></td><td>Settings</td></tr></table>
</div>
